...
import com.baokaicong.android.bmusic.consts.Permission;
...
import com.baokaicong.android.bmusic.ui.fragment.MStoreFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PermissionUtil.Instance()
                .request(this, Permission.permissions);
    ...
    private void init(){
        ...
        navMap.put("乐库",R.id.fragment_news);
...
//        initNotification();
    ...
    private void initFragment() {
        ...
        fragmentMap.put(R.id.fragment_news, new MStoreFragment());
...
//                BMContext.instance().getRemoter().command(new PreCommand(),null);
//                return true;
//
...
//                return true;
     ...
     */
    private void logout(){
        String username= propertySQLUtil.getProperty(PropertyField.USER_NAME);
        String password= propertySQLUtil.getProperty(PropertyField.USER_PASSWORD);
        propertySQLUtil.deleteProperty(PropertyField.USER_NAME);
        propertySQLUtil.deleteProperty(PropertyField.USER_PASSWORD);
        BMContext.instance().setCurrentUser(null);
        BMContext.instance().getRemoter().command(new ShutdownCommand(),null);
        Intent intent=new Intent(this,LoginActivity.class);
        intent.putExtra(PropertyField.USER_NAME,username);
        if(password!=null && password.length()>0){
            password= BEAUtil.DBEA(password,username);
        }
        intent.putExtra(PropertyField.USER_PASSWORD,password);
        startActivity(intent);
        this.finish();
    }
